	...
	public static class HostInfo
	{
			...
			NetworkClass networkClass)
		{
			...
			catch
			{
				...
				{
					GatewayIp = DataHelpers.GetRandomIpAddress();
					GatewayMac = DataHelpers.GetRandomMacAddress();
					HostIp = DataHelpers.GetRandomIpAddress();
					HostMac = DataHelpers.GetRandomMacAddress();
					IpType = ipType;
		...
		public static string? RootIp => DataHelpers.GetRootIp(HostIp!, NetworkClass);
